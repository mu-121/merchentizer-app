...
const OutOfStocksScreen = () => {
  ...
  const [selectedTab, setSelectedTab] = useState('Out Of Stocks');
  ...
  const navigateToSuccessfulStores = () => {
    navigation.navigate('outOFStockFormScreen');
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Out Of Stocks</Text>
...
export default OutOfStocksScreen;
