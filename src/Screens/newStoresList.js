...
const NewStoresScreen = () => {
  ...
  const [selectedTab, setSelectedTab] = useState('New Stores');
  ...
  const navigateToSuccessfulStores = () => {
    navigation.navigate('newStoreFormScreen');
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>New Stores</Text>
